...
The JavaScript-implementation of the plugin should be described like the following: YourPlugin <-is_instance- YourPluginImpl -is_a-> ClientSideWorker; YourPluginImpl -language-> JavaScript. The actual implementation should be linked via the attribute.
