...
module.exports = class SciViEditor {
    constructor() {
        this.components = {};
        this.sockets = {};
        this.editor = null;
    ...
    registerNode(name, inputs, outputs, workerFunc, settingsFunc) {
        var _this = this;
    ...
    placeVisual(desiredDepth, currentDepth, rootContainer, visualContainers, conID, forceDir) {
    ...
    addVisualToViewport(el, pos, forceDir) {
    ...
    changeSetting(settingName, settingID, nodeID) {
    ...
    uploadFile(settingName, settingID, nodeID) {
    ...
    uploadFiles(settingName, settingID, nodeID) {
        var sid = settingID + "_" + nodeID;
    ...
    startComm(address, addressCorrespondences, eon = null) {
