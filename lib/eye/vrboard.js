...
if (IN_VISUALIZATION) {
    ...
    if (!CACHE["container"]) {
        ...
        toolbar.appendChild(addCmdButton("Calibrate", { calibrate: true }));
        toolbar.appendChild(addCmdButton("Custom Caibrate", { customCalibrate: true }));
        toolbar.appendChild(addCmdButton("Toggle Controller", { setMotionControllerVisibility: true }));
