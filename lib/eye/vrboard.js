    ...
    else if (!CACHE["WebSocketCreated"])
    {
        ...
        websocket.onmessage = (evt) => {
            if (evt.data) 
            {
                ...
                if (msg["PlayAudioDescription"])
                {
                    CACHE["WallLog"] = [msg["Time"], "PlayAudioDescription", msg["PlayAudioDescription"]]
                    need_process = true;
                }
                if (msg["StopAudioDescription"])
                {
                    CACHE["WallLog"] = [msg["Time"], "StopAudioDescription", msg["StopAudioDescription"]]
                    need_process = true;
                }
