    ...
    if (!graph) {
        ...
        if (cl) {
            ...
            for (var i = 0, n = scaleLevels.length; i < n; ++i) {
                scales.push(scaleLevels[i].isDiscrete ? 
                            graph.createDiscreteScale(scaleLevels[i].steps,
                                                      scaleLevels[i].colors,
                                                      scaleLevels[i].textColors,
                                                      scaleLevels[i].names,
                                                      scaleLevels[i].fn) :
                            graph.createScale(scaleLevels[i].steps,
                                              scaleLevels[i].colors,
                                              scaleLevels[i].textColors,
                                              scaleLevels[i].names,
                                              scaleLevels[i].fn));
        ...
        var sortNodes = SETTINGS_VAL["Sort Nodes"];
        ...
        var renderer = graph.run(g_loc, states, scales, colors, title, info, classifier, container[0], sortNodes);
