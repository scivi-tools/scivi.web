...
if (IN_VISUALIZATION) {
    ...
    if (!electrodes) {
        ...
        container.appendChild(electrodes);
        ...
        container.appendChild(tooltip[0]);
    ...
    if (loaded && HAS_INPUT["EEG"]) {
        ...
        for (var i = 0; i < eeg[0].length; ++i) {
            ...
            const offset = 5;
            if (el) {
                el.style = elVal < 0 ? "fill: #929292" : "fill: hsl(" + lerp(104, 0, th, cap, elVal) + ", " + lerp(75, 100, th, cap, elVal) + "%, 50%)";
                ...
                if (!CACHE["EventListeners"][elName]) {
                    ...
                    p.addEventListener("mouseover", function (e) {
                        ...
                        tt.html(CACHE["Values"][mainEl.id.toLowerCase()] + " kΩ");
