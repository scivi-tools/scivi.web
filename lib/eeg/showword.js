if (IN_VISUALIZATION && HAS_INPUT["Word"]) {
    ...
    if (!wordDiv) {
        ...
        wordDiv.style = "position: absolute; top: 50%; left: 0; right: 0; margin: auto; text-align: center; font: 50px Helvetica Neue, Helvetica, Arial, sans-serif; -webkit-transform: translateY(-50%); -ms-transform: translateY(-50%); transform: translateY(-50%); color: #e6e6e6;";
