 ...
 *
 * This script is a client-side worker displaying a report about sources.
 */
 ...
 * @param dataNonGaia - histogram values of non-Gaia stars.
 * @param dataGaia - histogram values of Gaia stars.
 * @param thickness - column thickness of the histogram.
 * @param gauss - Gaussian fitted to the histogram.
 * @param canvas - canvas ID to draw on.
 */
...
/**
 * Display a scatter plot (aka a map).
 *
 * @param caption - chart caption.
 * @param dataPathNonGaia - URL of file with the non-Gaia stars.
 * @param dataPathGaia - URL of file with the Gaia stars.
 * @param minVal - minimum value.
 * @param maxVal - maximum value.
 * @param minX - minimum value of the X axis.
 * @param maxX - maximum value of the X axis.
 ...
 * @param interestRegion - polygon defining the interest region.
 * @param isJORS - flag, determining if the coordinates are exprexxed in JORS (true) or GRS (false).
 * @param canvas - canvas ID to draw on.
 */
    ...
    const html = `
        ...
        <div class="report-dashrow" style="margin-top: 20px;">
            <div class="report-dashbox">
                ...
                ${ReportHelpers.placeChart("upsilonUpdatesHist", ReportHelpers.calcChartWidth(2, 0, 0), 400)}
            </div>
            <div class="report-dashbox">
                <h3>Updates Histogram for 𝜌</h3>
                ${ReportHelpers.placeChart("rhoUpdatesHist", ReportHelpers.calcChartWidth(2, 0, 0), 400)}
            </div>
        </div>
        <div class="report-dashrow" style="margin-top: 20px;">
            <div class="report-dashbox">
                <h3>Updates Map for 𝜐 [μas] in GRS</h3>
                ${ReportHelpers.placeChart("upsilonUpdatesGRSMap", ReportHelpers.calcChartWidth(4, 0, 0), 400)}
            </div>
            <div class="report-dashbox">
                <h3>Updates Map for 𝜌 [μas] in GRS</h3>
                ${ReportHelpers.placeChart("rhoUpdatesGRSMap", ReportHelpers.calcChartWidth(4, 0, 0), 400)}
            </div>
            <div class="report-dashbox">
                <h3>Updates Map for 𝜐 [μas] in JORS</h3>
                ${ReportHelpers.placeChart("upsilonUpdatesJORSMap", ReportHelpers.calcChartWidth(4, 0, 0), 400)}
            </div>
            <div class="report-dashbox">
                <h3>Updates Map for 𝜌 [μas] in JORS</h3>
                ${ReportHelpers.placeChart("rhoUpdatesJORSMap", ReportHelpers.calcChartWidth(4, 0, 0), 400)}
            </div>
        </div>
    `;
