 ...
 *
 * This script is a client-side worker displaying histograms.
 */

/**
 * Chart point hover callback.
 *
...
function pointHoveredCB(point, phase)
{
    ...
    if (point)
    {
        ...
        case "changed":
        {
            ...
            tooltip.innerHTML = `${cs.xAxis.caption.text}: ${point.x.toExponential(3)}<br/>${cs.yAxis.caption.text}: ${point.y}`;
        }
            break;
