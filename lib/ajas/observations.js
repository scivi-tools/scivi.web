...
function histogramTemplate(config)
{
    return {
...
async function buildStats(solutionID)
{
    ...
    const html = `
        ...
        <div class="report-dashrow">
            ...
            <div class="report-dashbox">
                ...
                <div style="width: ${calcChartWidth(2, 1, 300)}px; height: 400px;" onclick="NChart3DLib.chart.obsPerSrcHist();">
    ...
    await createChart((chart) => {
        ...
        chart.obsPerSrcHist = () => {
            ...
            SCIVI.runTemplate(histogramTemplate(chartConfig));
        };
