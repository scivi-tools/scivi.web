    ...
    const html = `
        ...
        <div class="report-dashrow">
            ...
            <div class="report-dashbox">
                ...
                <div style="width: ${ReportHelpers.calcChartWidth(2, 1, 300)}px; height: 400px;" onclick="NChart3DLib.chart.obsPerSrcHist();">
                    <canvas id="obsPerSrcHist" style="width: 100%; height: 100%;"></canvas>
                </div>
            </div>
            <div class="report-dashbox">
                <h3>Observations per Source Map</h3>
                <div style="width: ${ReportHelpers.calcChartWidth(2, 1, 300)}px; height: 400px;" onclick="NChart3DLib.chart.obsPerSrcScatter();">
