 ...
 *
 * This script is a client-side worker displaying a report about observations.
 */

/**
 * Display the observations report.
 *
    ...
    const html = `
        ...
        <div class="report-dashrow">
            ...
            <div class="report-dashbox">
                ...
                ${ReportHelpers.placeChart("obsPerSrcHist", ReportHelpers.calcChartWidth(2, 1, 300), 400)}
            </div>
            <div class="report-dashbox">
                <h3>Observations per Source Map</h3>
                ${ReportHelpers.placeChart("obsPerSrcScatter", ReportHelpers.calcChartWidth(2, 1, 300), 400)}
            </div>
        </div>
    `;
