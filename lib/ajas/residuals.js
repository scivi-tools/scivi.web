...
async function plotHistGauss(caption, data, minX, maxX, minY, maxY, color, gaussS1, gauss, canvas)
{
...
function cmos(n, stats, coord, res)
{
    ...
    return `
        ...
        <div class="report-detector-dashrow">
            ...
            <div style="width: ${ReportHelpers.calcChartWidth(4, 0, 500)}px; height: 200px;">
