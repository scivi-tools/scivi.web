...
var ReportHelpers = {
    ...
    template: (config, solutionID, type) =>
    {
        return {
    ...
    {
        return ReportHelpers.template(config, solutionID, "Histogram");
    },

    scatterTemplate: (config, solutionID) =>
    {
        return ReportHelpers.template(config, solutionID, "Scatter");
    },
