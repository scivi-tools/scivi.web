...
if (IN_VISUALIZATION)
{
    ...
    const use_auto_orientation_detection = SETTINGS_VAL["Use Auto Orientation Detection"];
	...
	console.log(use_auto_orientation_detection);
    ...
    const graph_view_configuration = {
        ...
        use_auto_orientation_detection: use_auto_orientation_detection
    };
