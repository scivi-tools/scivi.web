...
if (IN_VISUALIZATION)
{
    ...
    const CircleLayoutConfig = {
        "R": {min: 10, max: 80, default: 40, step: 1, value: 40}
    }

    //настройка для укладки фрухтермана рейнгольда
    const FruchtermanReingoldConfig = {
        "iterations_count" : {min: 10, max: 1000, default: 100, step: 5, value: 100},
        "optimal_vertex_distance" : {min: 1, max: 50, default: 15, step: 1, value: 15},
        "is_bounding" : {min: 0, max: 1, default: 1, step: 1, value: 1}
    }
    ...
    const graph_view_configuration = {
        ...
        label_font_size: 15,
        scene_size: 80,
        scroll_range: {min: 1, max: 5, default: 1, step: 1}
    };
